...
title: "Flatten Northstar tasks and compact historic generations in convergence"
...
Run the one-time Northstar flattened-task switchover in `convergence`. Compact
...
- Integration checkout: `/Users/tom/Dev/projects/convergence` on clean, synchronized `main` at the commit
